...
public class Chest extends EquipableItem {
	private static final long serialVersionUID = 2702320790001355324L;
	private static String[][] names = { { "Plain shirt", "Plaid shirt" },
			{ "Trendy jerkin", "Leather vest" },
			{ "Chainmail vest", "Soldier's chestpiece" },
			{ "Infernal armour", "Demonic chestpiece", "Bloodied armour" },
			{ "Steel chestplate", "Palandin's chestpiece" },
			{ "Golden chestplate", "Shiny armour", "More money than sense" },
			{ "Crystal chestplate", "Chestplate of the gods" }
	...
	public Chest(String name, int pr, int mr, int dc) {
		Name = name;
		Slot = 3;
		XTextureRef = 4;
