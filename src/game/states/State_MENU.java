...
public class State_MENU extends State {
		...
		try {
			...
			Texture button1 = TextureLoader
					.getTexture(
							"PNG",
							ResourceLoader
									.getResourceAsStream("res/Materials/GUI/Buttons/SinglePlayerButton.png"),
			...
			Texture button2 = TextureLoader
					.getTexture(
							"PNG",
							ResourceLoader
									.getResourceAsStream("res/Materials/GUI/Buttons/MultiPlayerButton.png"),
							false, GL11.GL_NEAREST);
			...
			Texture button3 = TextureLoader
					.getTexture(
							"PNG",
							ResourceLoader
									.getResourceAsStream("res/Materials/GUI/Buttons/PrefabEditorButton.png"),
							false, GL11.GL_NEAREST);
	...
	protected void ProcessInput() {
		...
		if (GUI.isButtonDown(0)) {
			GameState.SwitchToState(GameState.State_Menu,
					GameState.State_Menu_SinglePlayer);
		}
		if (GUI.isButtonDown(1)) {
			GameState.SwitchToState(GameState.State_Menu,
					GameState.State_Menu_Multiplayer);
		}
